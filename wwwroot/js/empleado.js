  ...
  empleados.forEach((e) => {
    tbody.innerHTML += `
      <tr>
        ...
        <td>
          <button class="btn btn-sm btn-warning me-1" onclick="editarEmpleado(${e.id}, '${e.nombreyApellido}', '${e.area}', ${e.sueldo})">Editar</button>
...
function logout() {
  ...
  // Redireccionar forzado y evitar cache
